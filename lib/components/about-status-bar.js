...
export default class AboutStatusBar extends EtchComponent {
  constructor () {
    ...
    this.subscriptions.add(atom.tooltips.add(this.element, {title: 'An update will be installed the next time Thera is relaunched.<br/><br/>Click the squirrel icon for more information.'}))
  }
