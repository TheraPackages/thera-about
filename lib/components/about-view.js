      ...
      <div className='pane-item native-key-bindings about'>
        <div className='about-container'>
          <header className='about-header'>
            <a className='about-atom-io' href='http://oreo.alibaba-inc.com//'>
              <AtomLogo />
            </a>
            <div className='about-header-info'>
              <span className='about-version-container inline-block' onclick={this.handleVersionClick.bind(this)}>
                <span className='about-version'>{atom.getTheraVersion()}</span>
          ...
          <div className='about-credits group-item'>
            <p><span className='inline'>Core Features:  </span></p>
            <li><span className='inline'>Show weex render result on live. </span></li>
            <li><span className='inline'>White weex file with auto-complete and lint automaticly. </span></li>
          </div>
        </div>
      </div>
    )
